...
export const CoachingCard = {
  ...
  Link: { extends: 'ServiceCard.Link', attr: { href: '/from-workshops-to-1-on-1s' }, text: 'Learn more \u2192' }
}
...
export const FreelanceCard = {
  ...
  Link: { extends: 'ServiceCard.Link', attr: { href: '/hire-me-as-a-freelancer' }, text: 'Learn more \u2192' }
}
...
export const ReferencesCard = {
  ...
  Link: { extends: 'ServiceCard.Link', attr: { href: '/references-and-partners' }, text: 'Learn more \u2192' }
}
...
export const AngelCard = {
  ...
  Link: { extends: 'ServiceCard.Link', attr: { href: '/angel-investment' }, text: 'Learn more \u2192' }
}
...
export const DarkCardLink = {
  ...
  ':hover': { color: 'darkWhite68', gap: '9px' }
}
