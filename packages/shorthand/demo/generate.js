...
const md = [
  ...
  `| stringify | Shortened | Stringified | ${fmt(bigS - bigSt)} | ${pct(bigSt, bigS)}% of shortened |`,
  `| stringifyFurther | Stringified | StringifiedFurther | ${fmt(bigSt - bigSF)} | ${pct(bigSF, bigSt)}% of stringified |`,
  '',
  '---',
  '',
