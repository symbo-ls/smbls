...
import { publishProjectVersion } from '../../../../helpers/projectsApi.js'
...
export function registerProjectVersionsPublishCommand (versionsCmd) {
  versionsCmd
    ...
    .action(async (versionId, opts) => {
      ...
      const payload = await publishProjectVersion(projectId, versionId, body, authToken)
