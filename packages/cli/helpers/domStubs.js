...
/**
 * Provides browser API stubs for Node.js environment.
 * Used by the CLI when bundling and loading user projects
 * that reference browser globals (window, document, navigator, etc.).
 */
...
const fakeSheet = {
  cssRules: [],
  insertRule: function (r, i) { this.cssRules.splice(i || 0, 0, { cssText: r }) },
  deleteRule: noop,
...
const stub = {
  ...
  createElement: function () {
    var el = Object.create(stub)
    el.sheet = {
      cssRules: [],
      insertRule: function (r, i) { el.sheet.cssRules.splice(i || 0, 0, { cssText: r }) },
      deleteRule: noop
    }
    return el
  },
...
stub.head = Object.create(stub)
stub.body = Object.create(stub)
